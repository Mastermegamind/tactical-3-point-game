...
- Missing cache files → Use standard AI
- Invalid JSON → Use standard AI
- Network errors → Use standard AI
- No training data → Use standard AI
...
- Identifies common patterns (e.g., center → corner → edge)
- Ranks by frequency
