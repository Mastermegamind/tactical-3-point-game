...
if ($sessionId) {
    ...
    // Redirect to include session ID in URL for persistence on refresh
    header("Location: play.php?session=$sessionId");
    exit;
}
...
<head>
  ...
  <title>Playing - Okwe - Tactical Pebble Game</title>
...
<div class="game-container">
  <div class="game-card">
    <div class="game-header">
      <h1 class="game-title">Okwe - Tactical Pebble Game</h1>
